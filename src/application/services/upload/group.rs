...
use crate::application::services::upload_service::UploadPartParams;
use crate::debug;
...
pub async fn upload(
    ...
    let url = group::orchestration::GET_FILE_UPLOAD_URL;
...
async fn upload_file(
    ...
    let part_size = crate::application::services::upload_service::get_part_size(file_size, 0);
